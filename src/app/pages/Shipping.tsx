  ...
  return (
    <div className="pt-28 px-6 max-w-6xl mx-auto space-y-16 text-black dark:text-white">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-4 border border-gray-200 dark:border-neutral-700 rounded-2xl p-6 bg-white dark:bg-neutral-900 hover:shadow-md transition">
      ...
      {/* Contact */}
      <div className="text-center space-y-5 border-t border-gray-200 dark:border-neutral-700 pt-10">
        ...
        <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2 pb-10">
